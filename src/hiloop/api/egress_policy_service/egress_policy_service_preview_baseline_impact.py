...
from ...models.preview_baseline_impact_request import PreviewBaselineImpactRequest
from ...models.preview_baseline_impact_response import PreviewBaselineImpactResponse
...
) -> ErrorBody | PreviewBaselineImpactResponse | None:
    if response.status_code == 200:
        response_200 = PreviewBaselineImpactResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorBody | PreviewBaselineImpactResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorBody | PreviewBaselineImpactResponse
    """
