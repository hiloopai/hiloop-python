...
T = TypeVar("T", bound="GetAnnotationSchemaResponse")
...
class GetAnnotationSchemaResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_annotation_schema_response = cls(
            schema=schema,
        )

        get_annotation_schema_response.additional_properties = d
        return get_annotation_schema_response
