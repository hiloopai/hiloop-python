...
T = TypeVar("T", bound="StartVolumePushRequest")
...
class StartVolumePushRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_volume_push_request = cls(
            volume_id=volume_id,
        )

        start_volume_push_request.additional_properties = d
        return start_volume_push_request
