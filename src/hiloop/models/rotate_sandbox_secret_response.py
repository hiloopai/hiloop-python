...
T = TypeVar("T", bound="RotateSandboxSecretResponse")
...
class RotateSandboxSecretResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rotate_sandbox_secret_response = cls(
            secret=secret,
        )

        rotate_sandbox_secret_response.additional_properties = d
        return rotate_sandbox_secret_response
