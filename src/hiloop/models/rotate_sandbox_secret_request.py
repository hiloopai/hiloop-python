...
T = TypeVar("T", bound="RotateSandboxSecretRequest")
...
class RotateSandboxSecretRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rotate_sandbox_secret_request = cls(
            id=id,
            value=value,
        )

        rotate_sandbox_secret_request.additional_properties = d
        return rotate_sandbox_secret_request
