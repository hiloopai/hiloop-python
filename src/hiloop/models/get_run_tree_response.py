...
T = TypeVar("T", bound="GetRunTreeResponse")


@_attrs_define
class GetRunTreeResponse:
    """
    Attributes:
        runs (list[Run] | Unset): The runs on this page, ordered by lineage_path (so within a page each parent precedes
            its
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_run_tree_response.additional_properties = d
        return get_run_tree_response
