...
T = TypeVar("T", bound="SetAgentLaunchAclResponse")


@_attrs_define
class SetAgentLaunchAclResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        set_agent_launch_acl_response = cls(
            agent=agent,
        )

        set_agent_launch_acl_response.additional_properties = d
        return set_agent_launch_acl_response
