...
class UpdateProjectRequest:
    ...
    Attributes:
        ...
        description (str | Unset): The new free-text description (at most 4 KiB). An empty value clears it; omitted
            leaves it
             unchanged.
        display (list[ProjectDisplayRule] | Unset): Replaces the project's whole display configuration when non-empty
            (at most one rule per
             schema); empty leaves it unchanged. To remove the configuration entirely, set clear_display.
        clear_display (bool | Unset): Clears the display configuration back to unconfigured. Cannot be combined with
            display rules.
    """
    ...
    clear_display: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if clear_display is not UNSET:
            field_dict["clear_display"] = clear_display
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clear_display = d.pop("clear_display", UNSET)
