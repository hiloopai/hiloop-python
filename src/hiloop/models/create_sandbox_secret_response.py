...
T = TypeVar("T", bound="CreateSandboxSecretResponse")
...
class CreateSandboxSecretResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_sandbox_secret_response = cls(
            secret=secret,
        )

        create_sandbox_secret_response.additional_properties = d
        return create_sandbox_secret_response
