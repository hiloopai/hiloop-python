...
class CreateAgentRequest:
    """
    Attributes:
        name (str | Unset): The agent name to register — unique within the tenant. Lowercase letters, digits, `.`, `_`,
             and `-`; must start and end with a letter or digit; at most 100 characters.
        description (str | Unset): A free-text description of what the agent is for. Optional.
    """
